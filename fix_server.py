# Run this script from inside your traffic-control-env folder:
# cd ~/Downloads/traffic-control-env
# python3 fix_server.py

import os

# ── models.py ────────────────────────────────────────────────────────────────
open('models.py', 'w').write("""\
...
open('server/traffic_control_env_environment.py', 'w').write("""\
...
""")
print("✓ server/traffic_control_env_environment.py")

# ── server/app.py ─────────────────────────────────────────────────────────────
open('server/app.py', 'w').write("""\
import sys, os
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
print()
print("All files written. Now run:")
